const Simple = () => {
  return (
    <div className="simple-bg relative" id="id-section">
      ...
      <div className="mx-auto max-w-5xl py-24 px-6">
        ...
        <p className="text-center text-bluish text-lg font-normal mb-8">
          We are always open to discussions about product design, work
          collaboration or partnerships.
          <br /> Just contact us via the media below.
        </p>
        <div className="flex justify-center ">
          <a href="https://ibrahimelgibran.com/contact">
